...
export function useEnrichedMatches(matches: MatchModel[]): { data: MatchModel[], isLoading: boolean } {
    ...
    const isLoading = leagueStandings.some(q => q.isLoading) || teamFormResults.some(q => q.isLoading);
